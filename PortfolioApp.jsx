  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-slate-100 antialiased">
      <style>{`
        ...
        /* make input/textarea text and placeholders bright on dark background */
        input, textarea {
          color: #ffffff;
        }
        ...
        /* ensure borders look subtle on dark bg */
        .form-border {
      ...
      <main className="max-w-6xl mx-auto px-6 py-12" id="home">
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <a href="#portfolio" className="border border-slate-200 px-4 py-2 rounded-md text-slate-700">View Work</a>
            </div>
          ...
          <div className="flex justify-center md:justify-end">
            {/* Ensure file is in public/assets/vardhasheela.jpeg */}
            <img src="/assets/vardhasheela.jpeg" alt="Vardhasheela N" className="w-72 h-72 rounded-xl object-cover shadow-lg border-2 border-pink-500/40" />
          </div>
        </section>
        ...
        <section id="services" className="mt-16">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-neutral-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="mt-2 text-slate-300 text-sm">Interview prep, grooming tips, mock rounds, and practical advice from someone who’s trained cabin crew. Great for freshers preparing for airline hiring rounds and for anyone needing presentation & grooming guidance.</p>
              <ul className="mt-3 text-sm text-slate-300 space-y-1">
        ...
        <section id="portfolio" className="mt-16">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6">
            {/* Example cards (thumbnails are in public/assets) */}
            <div className="bg-neutral-800 rounded-lg overflow-hidden shadow-neon neon-border border-2 border-indigo-400/30">
              <div className="aspect-video bg-slate-800">
                <img src="/assets/english.png" alt="English Cashcow Thumbnail" className="w-full h-full object-cover"/>
              </div>
              <div className="p-4">
            ...
            <div className="bg-neutral-800 rounded-lg overflow-hidden shadow-neon neon-border border-2 border-pink-400/30">
              <div className="aspect-video bg-slate-800">
                <img src="/assets/tamil.png" alt="Tamil Cashcow Thumbnail" className="w-full h-full object-cover"/>
              </div>
              <div className="p-4">
            ...
            <div className="bg-neutral-800 rounded-lg overflow-hidden shadow-neon neon-border border-2 border-green-400/30">
              <div className="aspect-video bg-slate-800">
                <img src="/assets/documentary.png" alt="Documentary Thumbnail" className="w-full h-full object-cover"/>
              </div>
              <div className="p-4">
                <div className="font-semibold">Documentary Style Edit</div>
                <div className="text-sm text-slate-300 mt-2">Story-driven cinematic edit focused on pacing and narrative.</div>
              </div>
            </div>

            <div className="bg-neutral-800 rounded-lg overflow-hidden shadow-neon neon-border border-2 border-yellow-400/30">
              <div className="aspect-video bg-slate-800">
                <img src="/assets/shorts.png" alt="Shorts & Reels Thumbnail" className="w-full h-full object-cover"/>
              </div>
              <div className="p-4">
                <div className="font-semibold">Shorts / Reels</div>
                <div className="text-sm text-slate-300 mt-2">High-energy social edits optimised for engagement and shareability.</div>
              </div>
            </div>
        ...
        <section id="about" className="mt-16">
          ...
          <p className="mt-2 text-slate-300 max-w-2xl">A short story about my journey — from cabin crew to instructor to technical support & freelance editor.</p>

          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-neutral-800 p-6 rounded-lg shadow-sm">
              <h3 className="font-bold">My Journey</h3>
              <p className="mt-3 text-slate-300">I began my career as cabin crew, later worked as an instructor, and transitioned into technical support while freelancing as a video editor. I help clients with both technical training and creative content.</p>
            ...
            <aside className="bg-neutral-800 p-6 rounded-lg shadow-sm">
              ...
              <ul className="mt-3 text-sm text-slate-300 space-y-2">
                ...
                <li>• WordPress basics (coming soon)</li>
                <li>• AWS basics: S3, EC2 (learning)</li>
              </ul>

              <div className="mt-6">
                <h5 className="font-bold">Availability</h5>
                <div className="text-sm text-slate-300 mt-2">Weekends & evenings for freelance work. Training sessions by appointment.</div>
              </div>
            </aside>
          </div>
        </section>
        ...
        <section id="contact" className="mt-16 mb-20">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <form className="bg-neutral-800 p-6 rounded-lg shadow-sm">
              ...
              <input className="mt-1 w-full form-border rounded px-3 py-2" placeholder="Your name" />

              <label className="block text-sm font-medium text-slate-400 mt-4">Email</label>
              <input className="mt-1 w-full form-border rounded px-3 py-2" placeholder="you@example.com" />

              <label className="block text-sm font-medium text-slate-400 mt-4">Message</label>
              <textarea className="mt-1 w-full form-border rounded px-3 py-2" rows={4} placeholder="Tell me about your project"></textarea>

              <div className="mt-4 flex items-center gap-3">
                <button className="bg-indigo-600 text-white px-4 py-2 rounded-md">Send Message</button>
                <a className="text-sm text-slate-500">Or message on WhatsApp</a>
              </div>
            </form>
            ...
            <aside className="bg-neutral-800 p-6 rounded-lg shadow-sm">
              ...
              <div className="mt-6">
                ...
                <div className="mt-2 flex gap-3">
                  <a className="text-sm text-indigo-600">Instagram</a>
                  <a className="text-sm text-indigo-600">YouTube</a>
                  <a className="text-sm text-indigo-600">LinkedIn</a>
                </div>
              </div>
            </aside>
          </div>
